...
import type { TelemetryColumn } from '../../../../shared/ipc/contracts';
import {
...
export function DefaultTemplate() {
  ...
  const staticData = data.ups.static;
  const dynamicData = data.ups.dynamic;
  const lastTelemetry = data.telemetry.latest;
  const history = data.telemetry.history;
  const config = data.config;
  const localDriverLaunchIssue = data.connection.driverIssue;
